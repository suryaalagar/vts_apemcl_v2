        ...
        $(document).ready(function () {
         ...
         $('.adduser').hide(); 
          ...
          if (device_type=='1' ||device_type=='17' || device_type=='18') 
          {
                   $(".fuel_types").hide();
           ...
           //  alert(device_type);
           if (device_type=='1' || device_type=='3' || device_type=='10' || device_type=='17' || device_type=='18') 
           {
              ...
              if (device_type=='2' || device_type=='4' ||  device_type=='11' || device_type=='12' || device_type=='14' || device_type=='15') 
           // alert(device_type);
             {
                 $(".fuel_types").show();  
                 $(".fueltype_analog").hide(); 
             ...
             if (device_type=='8' || device_type=='9') 
