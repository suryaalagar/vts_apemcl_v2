...
//=====================================================================================================       
    ...
    colors:$themeColor,
    series:[{name:"Nelson",type:"column",data:[23,11,22,27,13,22,37,21,44,22,30]},
        {name:"Vine",type:"area",data:[44,55,41,67,22,43,21,41,56,27,43]},
        {name:"Dribbble",type:"line",data:[30,25,36,30,45,35,64,52,59,36,39]}],
    fill:{
        opacity:[.85,.25,1],
    ...
    xaxis:{type:"datetime"},
    yaxis:{min:0},
    tooltip:{shared:!0,intersect:!1,y:{formatter:function(e){return void 0!==e?e.toFixed(0)+" views":e}}},
...
//===============================================================================================================        
        ...
        function generateData(e,a,t)
        {
            for(var r=0,n=[];r<a;)
            {
                var i=Math.floor(Math.random()*(t.max-t.min+1))+t.min,o=Math.floor(61*Math.random())+15;n.push([e,i,o]),e+=864e5,r++
            }
            return n
        }
        var threedBubbleChart={chart:{height:350,type:"bubble"},
            dataLabels:{enabled:!1},
            series:[{name:"Product1",data:generateData(new Date("11 Feb 2017 GMT").getTime(),20,{min:10,max:60})},
                {name:"Product2",data:generateData(new Date("11 Feb 2017 GMT").getTime(),20,{min:10,max:60})},
                {name:"Product3",data:generateData(new Date("11 Feb 2017 GMT").getTime(),20,{min:10,max:60})},
                {name:"Product4",data:generateData(new Date("11 Feb 2017 GMT").getTime(),20,{min:10,max:60})}],
            fill:{type:"gradient",colors:$themeColor},
    ...
    xaxis:{tickAmount:10,labels:{formatter:function(e){return parseFloat(e).toFixed(1)}}},
    yaxis:{tickAmount:7},
    fill:{colors:$themeColor}};
function generateDataHeat(e,a){
    for(var t=0,r=[];t<e;)
    {
        var n="w"+(t+1).toString(),i=Math.floor(Math.random()*(a.max-a.min+1))+a.min;r.push({x:n,y:i}),t++
    }
    return r
}
...
var heatmapBasicChart={
    ...
    colors:[$primary],
    series:[
        {name:"Metric1",data:generateDataHeat(18,{min:0,max:90})},
        {name:"Metric2",data:generateDataHeat(18,{min:0,max:90})},
        {name:"Metric3",data:generateDataHeat(18,{min:0,max:90})},
        {name:"Metric4",data:generateDataHeat(18,{min:0,max:90})},
        {name:"Metric5",data:generateDataHeat(18,{min:0,max:90})},
        {name:"Metric6",data:generateDataHeat(18,{min:0,max:90})},
        {name:"Metric7",data:generateDataHeat(18,{min:0,max:90})},
        {name:"Metric8",data:generateDataHeat(18,{min:0,max:90})},
        {name:"Metric9",data:generateDataHeat(18,{min:0,max:90})}],
    ...
    responsive:[
        ...
        {breakpoint:768,options:{chart:{width:520},legend:{position:"right"}}},
        {breakpoint:620,options:{chart:{width:450},legend:{position:"right"}}},
...
line_basic_chart=new ApexCharts(document.querySelector("#line-basic-chart"),lineBasicChart);
line_basic_chart.render();


var area_spline_chart=new ApexCharts(document.querySelector("#area-spline-chart"),areaSplineChart);
area_spline_chart.render();
var column_basic_chart=new ApexCharts(document.querySelector("#column-basic-chart"),columnBasicChart);
column_basic_chart.render();
var bar_basic_chart=new ApexCharts(document.querySelector("#bar-basic-chart"),barBasicChart);
bar_basic_chart.render();
var mixed_line_column_area_chart=new ApexCharts(document.querySelector("#mixed-line-column-area-chart"),mixedLineColumnAreaChart);
mixed_line_column_area_chart.render();
var candlestick_basic_chart=new ApexCharts(document.querySelector("#candlestick-basic-chart"),candlestickBasicChart);
candlestick_basic_chart.render();
var threeD_bubble_chart=new ApexCharts(document.querySelector("#threed-bubble-chart"),threedBubbleChart);
threeD_bubble_chart.render();
var scatter_basic_chart=new ApexCharts(document.querySelector("#scatter-basic-chart"),scatterBasicChart);
scatter_basic_chart.render();
var heatmap_basic_chart=new ApexCharts(document.querySelector("#heatmap-basic-chart"),heatmapBasicChart);
heatmap_basic_chart.render();
var pie_simple_chart=new ApexCharts(document.querySelector("#pie-simple-chart"),pieSimpleChart);
pie_simple_chart.render();
var pie_donut_simple_chart=new ApexCharts(document.querySelector("#pie-donut-simple-chart"),pieDonutSimpleChart);
pie_donut_simple_chart.render();
var radial_bar_multiple_chart=new ApexCharts(document.querySelector("#radial-bar-multiple-chart"),radialBarMultipleChart);
radial_bar_multiple_chart.render();
var radar_basic_chart=new ApexCharts(document.querySelector("#radar-basic-chart"),radarBasicChart);
