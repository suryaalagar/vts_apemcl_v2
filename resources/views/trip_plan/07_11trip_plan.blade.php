                    ...
                    <div class="card-content collapse show box-bordershado">
                        <div class="card-body">
                            <div class="btn-group role=" group">
                                <a href="{{ route('trip.create') }}"><button class="btn btn-outline-primary" type="button"> <i class="feather icon-user-plus icon-left"></i>
                                        Add Trip
                                    </button></a>
                            </div>
                            <ul class="nav nav-tabs nav-underline" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-value="1" id="baseIcon-tab21" data-toggle="tab" aria-controls="tabIcon21" href="#tabIcon21" role="tab" aria-selected="true" onchange="filterByDate()"><i class="fa fa-play"></i>All</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-value="2" id="baseIcon-tab24" data-toggle="tab" aria-controls="tabIcon24" href="#tabIcon24" role="tab" aria-selected="false"><i class="fa fa-flag"></i>In HUB</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-value="3" id="baseIcon-tab22" data-toggle="tab" aria-controls="tabIcon22" href="#tabIcon22" role="tab" aria-selected="false"><i class="fa fa-flag"></i>Trip Processing</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-value="4" id="baseIcon-tab23" data-toggle="tab" aria-controls="tabIcon23" href="#tabIcon23" role="tab" aria-selected="false"><i class="fa fa-cog"></i>Trip Completed</a>
                                </li>
                            </ul>
                            <div class="card">
                                ...
                                <div class="tab-content px-1 pt-1">
                                    <div class="tab-pane active" id="tabIcon21" role="tabpanel" aria-labelledby="baseIcon-tab21">
                                        <div class="card-content collapse show">
                                            <div class="card-body card-dashboard">
                                                <table class="table table-striped display nowrap table-bordered" id="datatable_all" style="width:100%">
                                    ...
                                    <div class="tab-pane" id="tabIcon24" role="tabpanel" aria-labelledby="baseIcon-tab24">
                                        <div class="card-content collapse show">
                                            <div class="card-body card-dashboard">
                                                <table class="table table-striped display nowrap table-bordered" id="datatable_inhub" style="width:100%">
                                                    <thead class="bg-primary">
                                                        <tr>
                                                            <th>S.No</th>
                                                            <th>Trip id</th>
                                    ...
                                    <div class="tab-pane" id="tabIcon22" role="tabpanel" aria-labelledby="baseIcon-tab22">
                                        <div class="card-content collapse show">
                                            <div class="card-body card-dashboard">
                                                <table class="table table-striped display nowrap table-bordered" id="datatable_processing" style="width:100%">
                                                    <thead class="bg-primary">
                                                        <tr>
                                                            <th>S.No</th>
                                                            <th>Trip id</th>
                                    ...
                                    <div class="tab-pane" id="tabIcon23" role="tabpanel" aria-labelledby="baseIcon-tab23">
                                        <div class="card-content collapse show">
                                            <div class="card-body card-dashboard">
                                                <table class="table table-striped display nowrap table-bordered" id="datatable_complete" style="width:100%">
                                                    <thead class="bg-primary">
                                                        <tr>
                                                            <th>S.No</th>
                                                            <th>Trip id</th>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" id="modalCloseButton" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
