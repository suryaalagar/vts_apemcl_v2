                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-simple" id="tripplanform" method="post" novalidate
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" class="form-control start_input" name="start_latitude"
                                        id="start_latitude" placeholder="Enter Start latitude">
                                    <input type="hidden" class="form-control start_input" name="start_longitude"
                                        id="start_longitude" placeholder="Enter Start Longitude">
                                    <input type="hidden" class="form-control end_input" name="end_latitude"
                                        id="end_latitude" placeholder="Enter End latitude">
                                    <input type="hidden" class="form-control end_input" name="end_longitude"
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        ...
                        if (array != '') {
                            $('#start_latitude').val(array.route_start_lat);
                            $('#start_longitude').val(array.route_start_lng);
                            $('#end_latitude').val(array.route_end_lat);
                            $('#end_longitude').val(array.route_end_lng);
