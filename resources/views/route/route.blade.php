                                            ...
                                            <div class="btn-group role="group">
                                                <a href="{{ route('route.route_create') }}"><button
                                                        class="btn btn-outline-primary" type="button"> <i
                                                            class="feather icon-user-plus icon-left"></i> Add Route
                                                    </button></a>
                                            </div>
                                        </div>
                                    </div>
            ...
            $(document).ready(function() {
                $('#datatable').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'route_start_locationname',
                            name: 'route_start_locationname'
                        },
                        {
                            data: 'route_end_locationname',
                            name: 'route_end_locationname'
                        },
                        {
                            data: 'start_lat_lng',
                            name: 'start_lat_lng'
