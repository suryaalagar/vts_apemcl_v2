            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">ADD Route </h4> <a class="heading-elements-toggle"><i
                            ...
                            <form class="form-horizontal form-simple" id="polygonform" method="post" novalidate
                                ...
                                <div class="row">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="encoded" id="encoded" value="">
...
@push('scripts')
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.message == 'Success') {
                            ...
                            window.location.href = '{{ route('trip_routes.index') }}';
                        }
    ...
    <li>
        <p>
            ...
            onSubmit: ({
                ...
                var routing_latlng = L.Routing.control({
                    ...
                    var encodedPolyline = $('#encoded').val();

                    var coordinates = L.Polyline.fromEncoded(encodedPolyline).getLatLngs();
                    // console.log("value" + coordinates)

                      // // Get the first and last coordinate of the polyline
                    var startLocation = coordinates[0];
                    var endLocation = coordinates[coordinates.length - 1];

                    // Set the #startlocation and #endlocation input values
                    $('#startlocation').val(startLocation.lat + "," + startLocation.lng);
                    $('#endlocation').val(endLocation.lat + "," + endLocation.lng);
                }).addTo(map);
        ...
        // var encoded = $('#encoded').val(polyvalue);;
