            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < parkdata.length; i++) {
                        ...
                        var start_datetime = parkdata[i].start_datetime;
                        var end_datetime = parkdata[i].end_datetime;
                        const popupContent =
                            '<div class="marker">' + "<p>Start TIme: <b>" + start_datetime + "</b></p>" + "<p>End TIme: <b>" + end_datetime + "</b></p>" + "<p>Duration(H:M:S): <b>" + park_duration + "</b></p>"
                        "</div>";
