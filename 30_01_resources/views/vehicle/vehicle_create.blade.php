            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success == 'Success') {
                        toastr.success("Data Inserted Successfully!", "INSERT", {
                            progressBar: !0
                        });
                        window.location.href = '{{ route('vehicle.index') }}';
                    }
                    if (data.success == 'validation') {
                        if (data.message.vehicle_name) {
                            toastr.warning(data.message.vehicle_name, "Decline", {
                                progressBar: !0
                            });
                        } else if (data.message.sim_mob_no) {
                            toastr.warning(data.message.sim_mob_no, "Decline", {
                                progressBar: !0
                            });
                        } else if (data.message.device_imei) {
                            toastr.warning(data.message.device_imei, "Decline", {
                                progressBar: !0
                            });
                        }

                    } else {
                        toastr.danger(data.message, "Error", {
                            progressBar: !0
                        });
                    }
                }
