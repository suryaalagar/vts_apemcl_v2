    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="feather icon-folder"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li class=" nav-item"><a href="{{ route('tripplanreport.tripplan_complete_report') }}"><i
                                class="feather icon-car"></i><span class="menu-title" data-i18n="Trip_plan">Completed Trips Report</span></a>
                    </li>
                </ul>
                <ul class="menu-content">
                ...
                <ul class="menu-content">
                    <li class=" nav-item"><a href="{{ route('keyonkeyoffreport.index') }}"><i
                                class="feather icon-car"></i><span class="menu-title" data-i18n="keyonkeyoff_report">Key
                                on Key off</span></a>
                    </li>
                </ul>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="feather icon-truck"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li class=" nav-item"><a href="{{ route('vehicle.index') }}"><i class="feather icon-car"></i><span
                                class="menu-title" data-i18n="Trip_plan">Vehicle</span></a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="feather icon-map-pin"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li class=" nav-item"><a href="{{ route('trip_routes.index') }}"><i
                                class="feather icon-car"></i><span class="menu-title"
