$((function() {
    ...
    $.app.menu.is_touch_device() ? ($(".sidebar-menu-list").css("overflow", "scroll"), $(".email-user-list").css("overflow", "scroll"), $(".compose-new-mail-sidebar").css("overflow", "scroll")) : ($(".sidebar-menu-list").length > 0 && new PerfectScrollbar(".sidebar-menu-list", {
        wheelPropagation: !1
    }), n.length > 0 && new PerfectScrollbar(".email-user-list", {
        wheelPropagation: !1
    }), $(".email-scroll-area").length > 0 && new PerfectScrollbar(".email-scroll-area", {
        wheelPropagation: !1,
        suppressScrollX: !0
    }), a.length > 0 && new PerfectScrollbar(".compose-new-mail-sidebar", {
        wheelPropagation: !1
    }));
